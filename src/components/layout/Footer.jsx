  ...
  return (
    ...
    <footer className="border-t border-white/[0.06] px-6 pb-24 pt-8 text-sm sm:pb-8">
        ...
        <div className="flex items-center gap-3">
          {SOCIALS.map(({ icon: Icon, label, href }) => (
            <a
              ...
              aria-label={label}
              title={label}
              className="muted hover:text-brand-400 dark:text-brand-300"
            >
              <Icon size={17} />
            </a>
          ))}
      ...
      <div className="mx-auto mt-4 flex max-w-7xl flex-wrap items-center justify-center gap-x-4 gap-y-1 border-t border-white/[0.06] pt-4 text-xs muted">
        <Link to="/sobre" className="hover:text-brand-400 dark:text-brand-300">Sobre</Link>
        <span className="text-gray-600">·</span>
        <Link to="/sobre" className="hover:text-brand-400 dark:text-brand-300">Termos de Uso</Link>
        <span className="text-gray-600">·</span>
        ...
        {isAuthenticated && (
          <>
            ...
            <button
              ...
              className="inline-flex items-center gap-1 hover:text-brand-400 dark:text-brand-300"
            >
