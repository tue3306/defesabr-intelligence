...
import { CheckCircle2, XCircle, Trophy, RotateCcw, Flame, ArrowRight } from 'lucide-react'
import { quizQuestions } from '../../data/learnData'
  ...
  if (finished) {
    ...
    return (
      <div className="card p-8 text-center">
        ...
        <p className="mt-1 text-sm muted">{msg}</p>
  ...
  return (
    <div className="card p-6">
      ...
      <div className="mb-4 flex items-center justify-between text-sm">
        <span className="font-semibold muted">Pergunta {idx + 1} de {total}</span>
