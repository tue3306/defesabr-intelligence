...
export default function Settings() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      {/* A CHAVE MUDOU DE LUGAR, E O MOTIVO É QUE ELA É CREDENCIAL.
        *
        * Configurações é uma tela que alguém abre para mudar o tema, às vezes
        * com outra pessoa olhando. Uma chave de API não pertence a esse
        * contexto: é credencial pessoal, e credencial mora junto das outras,
        * em Minha conta → Segurança.
        *
        * Fica o ponteiro, porque quem procurar por aqui precisa achar. */}
      {isAuthenticated && (
        <Section icon={KeyRound} title="Assistente por IA">
          <p className="text-sm muted">
            A chave do modelo é credencial pessoal e fica em{' '}
            <Link to="/conta" className="font-semibold text-brand-500 hover:underline dark:text-brand-300">
              Minha conta → Segurança
            </Link>
            , junto das outras informações da sua sessão.
          </p>
        </Section>
      )}
